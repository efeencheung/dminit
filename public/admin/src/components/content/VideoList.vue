                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">视频资讯列表</span>
                            </div>
                            <div class="actions">
                                <form action="/article/" method="get" v-on:submit.prevent="search">
                                    <div class="portlet-input input-inline input-medium">
                                        <div class="input-group">
                                            ...
                                            class="form-control input-sm" value="" placeholder="请输入部分或完整的视频资讯名">
                                            <span class="input-group-btn">
                                                <button class="btn btn-primary btn-sm" type="submit">查找</button>
                                            </span>
                                        </div>
                                    </div>
                                    <router-link to="/video/add" class="btn btn-sm green">添加新视频资讯</router-link>
                                </form>
                            </div>
                        </div>
								...
								<table class="table table-hover table-light">
									...
									<tbody>
										<tr v-for="entity in entities">
											...
											<td>
                                                <router-link :to="{ name: 'VideoEdit', params: { id: entity.id }}"><i class="fa fa-edit"></i></router-link>
												<a title="删除" href="javascript:;" v-on:click="deleteConfirm(entity.id)"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
									</tbody>
								</table>
...
export default {
    ...
    data: function(){
        return {
            entities: [],
            pageCount: 1,
            params: { page: 1, type: 3, orderBy: null, direction: null, keywords: null }
        }
    },
	created: function(){
        this.update()
