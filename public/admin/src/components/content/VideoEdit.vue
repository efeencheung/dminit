                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">视频资讯编辑</span>
                            </div>
                            <div class="actions">
                            ...
                            <form method="put" v-bind:action="'/article/'+entity.id" class="form-horizontal" 
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="entity[title]" class="form-control" 
                                                placeholder="请输入视频资讯标题" v-model="entity.title" />
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="entity[content]" class="form-control" 
                                                placeholder="请输入视频地址" v-model="entity.content" />
                                        </div>
                                        <div class="col-md-4">
                                            <span class="help-block" style="margin-top: 7px;"></span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="entity[summary]" class="form-control" rows="6" 
                                                placeholder="请输入视频简介(选填)" v-model="entity.summary"></textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <span class="help-block" style="margin-top: 7px;"></span>
                                        </div>
